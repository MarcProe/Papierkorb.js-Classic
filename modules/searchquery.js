...
let searchquery = {
    ...
    users: function (req, query, plain, flags) {
        if (req.query.delusers || req.body.delusers) {
            //check if we don't want users
            delete req.session.users;
        } else if (req.query.users) {
            //if a new search is requested
    ...
    docdate: function (req, query, plain) {
        if (req.query.deldocdate || req.body.deldocdate) {
            ...
            query.docdate = {};
            query.docdate.$gte = moment
                .utc(req.query.docdatefrom, "DD.MM.YYYY")
                .toISOString();
            query.docdate.$lte = moment
                .utc(req.query.docdateto, "DD.MM.YYYY")
                .toISOString();
            ...
            query.docdate = {};
            query.docdate.$gte = moment
                .utc(req.body.docdatefrom, "DD.MM.YYYY")
                .toISOString();
            query.docdate.$lte = moment
                .utc(req.body.docdateto, "DD.MM.YYYY")
                .toISOString();
            ...
            query.docdate = {};
            query.docdate.$gte = moment
                .utc(req.session.docdatefrom, "DD.MM.YYYY")
                .toISOString();
            query.docdate.$lte = moment
                .utc(req.session.docdateto, "DD.MM.YYYY")
                .toISOString();
